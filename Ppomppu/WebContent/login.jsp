...
<head>
    <title>로그인 화면</title>
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/css/popup_login.css?v=2022010301">
...
<body>
    <div class="popup_login">
    	<a href="<%=request.getContextPath() %>/index.jsp"><p class="log_top"><img src="<%= request.getContextPath() %>/images/logo.png"></p></a>
        <form name="zb_login" id="zb_login" method="post" action="https://www.ppomppu.co.kr/zboard/login_check.php?s_url=%2F">
        <input type="hidden" name="s_url" value="%2F" />
	        <ul class="login_box">
	            ...
	            <a href="#none" onclick="javascript:zb_login_check_submit();"><li class="log_btn"><span class="logtext jBtnLogin">로그인</span></li></a>
